...
from launch.actions import RegisterEventHandler,DeclareLaunchArgument, IncludeLaunchDescription, TimerAction, ExecuteProcess
...
def generate_launch_description():
    ...
    load_gripper_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'active',
             'gripper_controller', '-c', '/dsr01/gz/controller_manager'],
        output='screen'
    )
