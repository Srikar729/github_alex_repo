...
class VolumetricFlask500(Container):
    ...
    async def pour(self):
        ...
        srv_request.difference = Vector3(x=0.0, y=-10.0, z=0.0)
        ...
        srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        srv_request.difference = Vector3(x=0.0, y=0.0, z=-80.0)
        future = self.robot_control_srv.call_async(srv_request)
        await future
        ...
        # # Move closer
        # srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        # srv_request.difference = Vector3(x=0.0, y=15.0, z=0.0)
        # future = self.robot_control_srv.call_async(srv_request)
        # await future

        srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        srv_request.difference = Vector3(x=0.0, y=0.0, z=20.0)
        future = self.robot_control_srv.call_async(srv_request)
        await future

        # Turn the flask
        srv_request = ArmCommand.Request(command=ArmCommand.Request.TURN)
        srv_request.angle.z = 10.0
        future = self.robot_control_srv.call_async(srv_request)
        await future

        srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        srv_request.difference = Vector3(x=0.0, y=0.0, z=50.0)
        future = self.robot_control_srv.call_async(srv_request)
        await future

        # Move closer
        srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        srv_request.difference = Vector3(x=0.0, y=5.0, z=0.0)
        future = self.robot_control_srv.call_async(srv_request)
        await future

        # Turn the flask
        srv_request = ArmCommand.Request(command=ArmCommand.Request.TURN)
        srv_request.angle.z = 5.0
        future = self.robot_control_srv.call_async(srv_request)
        await future
        ...
        srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        srv_request.difference = Vector3(x=0.0, y=-90.0, z=0.0)
        future = self.robot_control_srv.call_async(srv_request)
        await future
        ...
        srv_request = ArmCommand.Request(command=ArmCommand.Request.RELATIVE_MOVEMENT)
        srv_request.difference = Vector3(x=0.0, y=-60.0, z=0.0)
        future = self.robot_control_srv.call_async(srv_request)
        await future
